...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (loginForm) {
    loginForm.addEventListener('submit', (e) => {
      ...
      if (!mobileInput || !passwordInput) {
        ...
        if (errorMessage) {
          errorMessage.textContent = 'Error: Required input field not found.';
  ...
  if (signupForm) {
    signupForm.addEventListener('submit', (e) => {
      ...
      console.log('Sign-up inputs:', { usernameInput, mobileInput, passwordInput, errorMessage });
      ...
      if (users.some(u => u.mobileNumber === mobileNumber)) {
        ...
        if (errorMessage) {
          errorMessage.textContent = 'Mobile number already registered.';
          errorMessage.style.display = 'block';
        }
        return;
      }
      ...
      try {
        ...
        alert('Failed to save user. Try clearing browser data.');
      }
    });
  } else {
